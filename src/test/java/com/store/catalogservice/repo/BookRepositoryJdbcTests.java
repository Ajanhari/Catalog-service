...
import com.store.catalogservice.config.DataConfig;
...
public class BookRepositoryJdbcTests {
    ...
    void findBookByIsbnWhenExisting() {
        ...
        var book = Book.of(bookIsbn, "Title", "Author", 12.90, "Ajan");
    ...
    @Test
    void findAllBooks() {
        var book1 = Book.of("1234561235", "Title", "Author", 12.90, "Ajan");
        var book2 = Book.of("1234561236", "Another Title", "Author", 12.90, "Ajan");
    ...
    void existsByIsbnWhenExisting() {
        ...
        var bookToCreate = Book.of(bookIsbn, "Title", "Author", 12.90, "Ajan");
